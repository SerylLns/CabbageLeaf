...
Article.create!(
  ...
  content:"<strong>Depuis vendredi, les 'thérapies de conversion' des homosexuels sont illégales en Albanie. Alors qu'un texte voté en mars 2018 par le Parlement européen enjoignait les pays des l'UE à interdire ces pratiques, peu d'États membres ont depuis légiféré en ce sens.</strong>
...
Article.create!(
  ...
  category: "europe, environnement, animal"
)
...
Article.create!(
  ...
  category: 'sport, environnement, europe'
)
...
Article.create!(
  ...
  Article.create!(
    ...
    category: "politique, environnement, amerique"
  )
  ...
  category: "business, amerique, femme"
  )
